...
app.get("/filter", (req, res) => {
  ...
  const specificTypeJoke = jokes.filter((joke) => joke.jokeType === type);
  
   res.json(specificTypeJoke);
...
app.post("/jokes", (req, res) => {
  ...
  console.log(jokes);
  res.json({ id : jokes.length + 1 , jokeText: text , jokeType: type ,});
});
//5. PUT a joke
...
app.delete("/all", (req, res) =>{
  ...
  if (req.headers.masterkey === masterKey){
  jokes = [];
  res.sendStatus(200);
  }
  else {
